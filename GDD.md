...
| **Art style** | **Stylized Western 2D illustration** (painterly, storybook, dignified — pivoted from anime 2026-07-07) with Islamic ornamental framing (geometry, illumination, calligraphy motifs in UI). **Chibi-first presentation (2026-07-06)**: the chibi with an idle breath IS the character everywhere in-game (battle, roster, Calling ceremony); portraits are secondary (reveal flourish, codex, marketing) |
